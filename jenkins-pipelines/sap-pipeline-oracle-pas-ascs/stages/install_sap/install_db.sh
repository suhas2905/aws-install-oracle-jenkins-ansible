...
echo "DATABASE_SID: $ORACLE_SID_CHKD" >> $VAR_FILE_FULL_PATH
echo "DATABASE_PRIVATE_IP: $ORACLE_PRIMARY_PRIVATE_IP" >> $VAR_FILE_FULL_PATH
echo "DATABASE_HOSTNAME: $ORACLE_INSTANCES_NAME_CHKD" >> $VAR_FILE_FULL_PATH
echo "DATABASE_INSTANCE_NUMBER: $ORACLE_INSTANCE_NUMBER_CHKD" >> $VAR_FILE_FULL_PATH
...
ansible-playbook $ansibleOracleDir/install_db.yml \
